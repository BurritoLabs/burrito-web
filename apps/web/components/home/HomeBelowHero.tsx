        ...
        <div className="wrap1400">
          <div className={styles.communityHeader}>
            <div className={styles.communityIntro}>
              <div className={styles.kicker}>Community commitment</div>
              <h2 id="community-title">
                Built to return value to the networks we serve
              </h2>
            </div>
            <div className={styles.communitySummary}>
              <p>
                Burrito allocates 15% of eligible fees generated by Burrito App
                and Burrito AI back to the ecosystems they operate on. Each
                contribution follows the selected network and is executed
                on-chain.
              </p>
              <div className={styles.communityScope}>
                <span>Burrito App</span>
                <span>Burrito AI</span>
                <strong>15% total allocation</strong>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            aria-label="Community fee allocation"
          >
            <article className={styles.allocation}>
              ...
              <div>
                <h3>Burn</h3>
                <p>
                  Removed from circulation through the applicable on-chain burn
                  mechanism.
                </p>
              </div>
            </article>
            ...
            <article className={styles.allocation}>
              ...
              <div>
                ...
                <p>
                  Directed to the community pool of the network where the fee
                  is generated.
                </p>
              </div>
            </article>
            ...
            <article
              className={`${styles.allocation} ${styles.networkAllocation}`}
            >
              <div className={styles.allocationNumber}>
                05<span>%</span>
              </div>
              <div>
                ...
                <p>
                  Allocated through the funding mechanism native to each
                  network.
                </p>
                <div className={styles.networkDestinations}>
                  <div className={styles.classicDestination}>
                    <span>Terra Classic</span>
                    <strong>Oracle Pool</strong>
                  </div>
                  <div className={styles.terraDestination}>
                    <span>Terra</span>
